...
## Project Structure
    ...
    ├── testapiautocatalog_114615  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_114615`
...
2. Clone this repo and `cd testapiautocatalog_114615`
